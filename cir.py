...
def solve_xy(k1, theta1, sigma1, k2, theta2, sigma2, t1, step, s1, s10):
    ...
    return optimize.fsolve(solve_helper, np.array([0.5, 0.5]))
...
def optimize_parameters(k1, theta1, sigma1, k2, theta2, sigma2, step, date, calib_period_len, swap_data):
    ...
    optimal_full = optimize.minimize(fun=optimize_helper, x0=initial_parameters_for_minimize, method='SLSQP', bounds=bnds, constraints=nonlin_con)
